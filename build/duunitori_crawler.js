...
(async () => {
    ...
    (0, monitoring_1.startCrawlerMonitoring)(CRAWLER_NAME);
    ...
    for await (const term of searchTerms) {
        ...
        (0, monitoring_1.recordCrawlerMetrics)(CRAWLER_NAME, term, urls.length);
        jobUrls.push(...urls);
    ...
    // Complete monitoring
    (0, monitoring_1.completeCrawlerMonitoring)(CRAWLER_NAME);
    ...
    try {
        ...
        try {
            ...
            if (jobUrls.length === 0) {
                ...
                try {
                    const allLinks = await page.$$eval('main a', (elements) => elements.map((el) => ({
                        href: el.href,
            ...
            (0, monitoring_1.recordCrawlerError)(CRAWLER_NAME, error instanceof Error ? error.message : String(error));
        }
